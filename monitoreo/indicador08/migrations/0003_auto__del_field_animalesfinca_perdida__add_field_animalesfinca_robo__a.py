...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnimalesFinca.perdida'
        db.delete_column('indicador08_animalesfinca', 'perdida')

        # Adding field 'AnimalesFinca.robo'
        db.add_column('indicador08_animalesfinca', 'robo', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AnimalesFinca.muerte'
        db.add_column('indicador08_animalesfinca', 'muerte', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AnimalesFinca.desc'
        db.add_column('indicador08_animalesfinca', 'desc', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AnimalesFinca.perdida'
        db.add_column('indicador08_animalesfinca', 'perdida', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'AnimalesFinca.robo'
        db.delete_column('indicador08_animalesfinca', 'robo')

        # Deleting field 'AnimalesFinca.muerte'
        db.delete_column('indicador08_animalesfinca', 'muerte')

        # Deleting field 'AnimalesFinca.desc'
        db.delete_column('indicador08_animalesfinca', 'desc')
    ...
    models = {
        ...
        'indicador08.animalesfinca': {
            ...
            'desc': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['grupo_gpae.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'muerte': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'produccion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicador08.ProductoAnimal']"}),
            'robo': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
