...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('grupo_gpae_recolector', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('grupo_gpae', ['Recolector'])

        # Adding model 'Organizaciones'
        db.create_table('grupo_gpae_organizaciones', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('logo', self.gf('monitoreo.grupo_gpae.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
            ('sitio_web', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('grupo_gpae', ['Organizaciones'])

        # Adding model 'Encuesta'
        db.create_table('grupo_gpae_encuesta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('recolector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupo_gpae.Recolector'])),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('organizacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupo_gpae.Organizaciones'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('grupo_gpae', ['Encuesta'])

        # Adding model 'Tenencia'
        db.create_table('grupo_gpae_tenencia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('grupo_gpae', ['Tenencia'])


    def backwards(self, orm):
        
        # Deleting model 'Recolector'
        db.delete_table('grupo_gpae_recolector')

        # Deleting model 'Organizaciones'
        db.delete_table('grupo_gpae_organizaciones')

        # Deleting model 'Encuesta'
        db.delete_table('grupo_gpae_encuesta')

        # Deleting model 'Tenencia'
        db.delete_table('grupo_gpae_tenencia')
