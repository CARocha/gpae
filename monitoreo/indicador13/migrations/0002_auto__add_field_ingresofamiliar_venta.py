...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IngresoFamiliar.venta'
        db.add_column('indicador13_ingresofamiliar', 'venta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IngresoFamiliar.venta'
        db.delete_column('indicador13_ingresofamiliar', 'venta')
    ...
    models = {
        ...
        'indicador13.ingresofamiliar': {
            ...
            'venta': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'indicador13.rubros': {
